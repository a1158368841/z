 ...
 * Tbfunction entities. Transaction control of the save(), update() and delete()
 * operations can directly support Spring container-managed transactions or they
 * can be augmented to handle user-managed Spring transactions. Each of these
 * methods provides additional information for how to configure it for the
 * desired type of transaction control.
 * 
 * @see com.zjut_java.model.Tbfunction
 * @author MyEclipse Persistence Tools
 */

public class TbfunctionDAO extends HibernateDaoSupport {
	private static final Logger log = LoggerFactory
			.getLogger(TbfunctionDAO.class);
	// property constants
	...
	public static TbfunctionDAO getFromApplicationContext(ApplicationContext ctx) {
		return (TbfunctionDAO) ctx.getBean("TbfunctionDAO");
	}
}